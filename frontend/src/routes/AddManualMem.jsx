...
const MovieForm = () => {
  ...
  return (
    <div className="flex flex-col items-center gap-4 p-4 sm:gap-6 sm:p-6">
      <p className="font-bn text-2xl text-[#E40C2B] sm:text-4xl">Add a New Membership</p>
      <form
      ...
      >
            ...
            <label className="w-full">
              ...
              >
                ...
                {membershipOptions.map((option) => (
                  <option key={option.membershipName} value={option.membershipName}>
        ...
        <button type="submit" className="bg-[#E40C2B] text-white px-8 py-2 rounded-xl">
          Add Membership
        </button>
      </form>
    </div>
